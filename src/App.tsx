...
export default function App() {
  ...
  const [points, setPoints] = useState<number>(88800);
  const [balance, setBalance] = useState<number>(1250000);
  const [rank, setRank] = useState<string>("KIM CƯƠNG");
  const [memberId, setMemberId] = useState<string>("VNC-888-999");
